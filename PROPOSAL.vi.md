...
**Bản viết nghiên cứu ngắn — dự án cá nhân để hiểu rõ vấn đề**

*[Tên của bạn], VinUniversity — [ngày]*
...
## 8. Xây dự án này dạy cho tôi điều gì

Việc tự dựng toàn bộ pipeline đã biến bài toán trừu tượng thành hiểu biết cụ thể. Bắt
đầu từ một repo trống, tôi dựng một mô phỏng FedAvg đúng, rồi một bộ tinh chỉnh
...
chung, đã pretrain*; và nhiễu DP phải được chia theo số client). Bài học lớn nhất: mỗi
trụ cột (riêng tư, học không nhãn, chuyển giao global↔local) nghe thì đơn giản nhưng
đầy đánh đổi ẩn khi thật sự cài đặt và *đo đạc* — đó chính là lý do tự tay làm đáng giá
hơn nhiều so với chỉ đọc.
